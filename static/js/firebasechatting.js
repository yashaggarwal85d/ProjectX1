...
class chat {
    ...
    buildProfile() {
        ...
        var url = `https://project-x1-0.herokuapp.com/accounts/profile_api/${this.user_id}/`;
        $.get(url, (data) => {
...
class Issuechat {
    ...
    buildIssue() {
        ...
        var url = `https://project-x1-0.herokuapp.com/issues/issue_detail_api/${this.issue_id}/`;
        $.get(url, (data) => {
            ...
            if (typeof value.data() != "undefined") {
                ...
                if (this.issue_id == value.data().issue && this.isactive) {
                    for (message of this.messages) {
                        ...
                        var url = `https://project-x1-0.herokuapp.com/accounts/profile_api/${message.sender}/`;
...
class Projectchat {
    ...
    buildProject() {
        ...
        var url = `https://project-x1-0.herokuapp.com/projects/project_detail_api/${this.project_id}/`;
        $.get(url, (data) => {
    ...
    await firebase
        ...
        .onSnapshot((value) => {
            ...
            chats.map((_chat, _index) => {
                ...
                var url = `https://project-x1-0.herokuapp.com/accounts/profile_api/${secondUser}/`;
                $.get(url, (data) => {
